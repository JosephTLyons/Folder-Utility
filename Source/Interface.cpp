...
Interface::Interface ()
{
    ...
    fontSizeForDirectoryPathSlider->setRange (10, 20, 1);
    ...
    fontSizeForDirectoryPathSlider->setValue(15);
    fontSizeForOutputSlider->setValue(30);
...
<JUCER_COMPONENT documentType="Component" className="Interface" componentName=""
  ...
  <SLIDER name="fontSizeSlider" id="507de9c129766a37" memberName="fontSizeForDirectoryPathSlider"
          ...
          textboxtext="ffffffff" textboxbkgd="ff3e3e3e" textboxoutline="ff3e3e3e"
          min="10" max="20" int="1" style="LinearHorizontal" textBoxPos="TextBoxLeft"
          textBoxEditable="1" textBoxWidth="25" textBoxHeight="20" skewFactor="1"
          needsCallback="1"/>
</JUCER_COMPONENT>
